...
def load_schema(schema_path):
    ...
    # 카테고리 (아우터만)
    schema['category'] = df[(df['category'] == 'Item') & (df['subcategory'] == 'Outer')]['label_ko'].tolist()
...
def main():
    ...
    output_dir = r'D:\kkokkaot\models\outer'
    target_category = '아우터'
    ...
    # 데이터 준비 (샘플링)
    print("\n데이터 준비 중...")
    sample_size = 19531  # 1 epoch 테스트를 위해 1000개 샘플링
